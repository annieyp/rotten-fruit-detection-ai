...
Usage:
    ...
    python3 pose.py --weights "/path/to/best.pt" --extrinsic-calibration extrinsic_calibration.json --camera-index 1 --live
"""
import argparse
...
def run_live(frame_source, model, camera_matrix, dist_coeffs, homography, confidence=0.3):
    ...
    box/orientation overlaid, updating every frame. Press 'q' in the window to quit."""
